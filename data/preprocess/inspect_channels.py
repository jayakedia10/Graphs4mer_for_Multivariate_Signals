...
def print_channel_info(edf_fn):
    ...
    try:
        ...
        missing_channels = [ch for ch in TUH_CHANNELS if ch not in edf_channels]
        extra_channels = [ch for ch in edf_channels if ch not in TUH_CHANNELS]
...
if __name__ == "__main__":
    ...
    # Specify a sample EDF file for inspection
